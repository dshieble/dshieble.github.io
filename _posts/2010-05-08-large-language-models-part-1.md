...
- *Traditional ML*: An ML model would consume this data as a single vector of engineered features. This vector does not need to be self-explanatory: we expect the ML model to learn to interpret the vector through its training data.
