...
$$RAD_n(\mathcal{G}) = E_{X_1, X_2, ..., X_n \sim \mathcal{D}_X} E_{\sigma_1, \sigma_2,..., \sigma_n} sup_{g \in \mathcal{G}} \frac{1}{n}\sum_{i=1}^{n} sigma_i g(X_i)$$
