...
Suppose $$\mathbf{D}, \mathbf{T}$$ are discrete subcategories of $$\mathbf{Met}$$ respectively formed from the sets
$$\{(\{x_1,x_2\}, d), (\{x_1,x_3\}, d), (\{x_1,x_2,x_3\}, d)\}$$
and
$$\{(\{x_1,x_2\}, d), (\{x_1,x_3\}, d)\}$$
and $$K: \mathbf{T} \rightarrow \mathbf{Part}$$ is a clustering functor defined as $$K(\{x_1,x_3\}, d) = \{\{x_1\},\{x_3\}\}, K(\{x_2,x_3\}, d)) = \{\{x_2\},\{x_3\}\}$$. Then:
...
Now suppose instead that $$\mathbf{D}, \mathbf{T}$$ are discrete subcategories of $$\mathbf{Met}$$ respectively formed from the sets
$$\{(\{x_1,x_2,x_3\}, d), \{x_1,x_2\}\}$$
and
$$\{(\{x_1,x_2,x_3\}, d)\}$$
and $$K: \mathbf{T} \rightarrow \mathbf{Part}$$ is $$K(\{x_1,x_2,x_3\}, d) = \{\{x_1, x_2\}, \{x_3\}\}$$. Then:
