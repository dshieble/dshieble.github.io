...
* Since there are no metric spaces in $$\mathbf{T}$$ with more than $$2$$ points, $$RanK(\{x_1,x_2,x_3\}, d) = \{\{x_1,x_2,x_3\}\}$$
...
* Since there is no metric space in $$\mathbf{T}$$ that contains $$x_2, x_3$$ and has fewer than $$3$$ points, $$LanK(\{x_2,x_3\}, d) = \{\{x_2\},\{x_3\}\}$$
...
NOTE: IS THIS TRUE (https://arxiv.org/pdf/0808.2241.pdf, theorem 4.1)
 ...
 -->
Instead, both $$RanK$$ and $$LanK$$ must be $$\delta$$-single linkage functors for some $$\delta_{RanK}, \delta_{LanK}$$:
