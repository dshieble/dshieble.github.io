...
* Since there are no metric spaces in $$\mathbf{T}$$ that contains both $$x_2, x_3$$ and have fewer than $$3$$ points, $$LanK(\{x_2,x_3\}, d) = \{\{x_2\},\{x_3\}\}$$
...
Note that unlike the first two examples we do not have $$K=RanK=LanK$$ on metric spaces in $$\mathbf{T}$$.
