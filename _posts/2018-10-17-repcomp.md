...
When I'm building models, I frequently run into situations where I've trained multiple models over a few datasets or tasks and I'm curious about how they compare. For instance, it's intuitively clear that if I train word vectors over the same Wikipedia dataset several times, each of the word vector models will be "similar" to each other. In contrast, if I train word vectors over a Twitter dataset, the new vectors will be "different." However, it's often unclear how to quantify this difference.
