...
Suppose we have three categories $$A, B, C$$ and two functors $$G: A \rightarrow B, K: A \rightarrow C$$. A Kan Extension of $$K$$ along $$G$$ is a functor $$F: B \rightarrow C$$ that we can build from these components in a universal way.
