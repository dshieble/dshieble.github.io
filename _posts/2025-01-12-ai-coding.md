...
As I debugged the system, I realized I was spending a lot of time downloading and opening the screenshots one-by-one. It was clear that the optimal developer experience would be for the system to generate and open a pdf of urls side-by-side with screenshots on my machine.
